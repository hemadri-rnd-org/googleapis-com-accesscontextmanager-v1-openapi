...
func Accesscontextmanager_accesspolicies_getiampolicyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateAccesscontextmanager_accesspolicies_getiampolicyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_resource_getIamPolicy",
		mcp.WithDescription("Gets the IAM policy for the specified Access Context Manager access policy."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Accesscontextmanager_accesspolicies_getiampolicyHandler(cfg),
	}
}
