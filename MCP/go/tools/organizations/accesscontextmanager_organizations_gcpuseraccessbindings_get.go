...
func Accesscontextmanager_organizations_gcpuseraccessbindings_getHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result models.GcpUserAccessBinding
...
func CreateAccesscontextmanager_organizations_gcpuseraccessbindings_getTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_v1_name",
		mcp.WithDescription("Gets the GcpUserAccessBinding with the given name."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Accesscontextmanager_organizations_gcpuseraccessbindings_getHandler(cfg),
	}
}
