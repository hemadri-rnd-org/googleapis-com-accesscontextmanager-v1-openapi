...
func Accesscontextmanager_organizations_gcpuseraccessbindings_createHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateAccesscontextmanager_organizations_gcpuseraccessbindings_createTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v1_parent_gcpUserAccessBindings",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Accesscontextmanager_organizations_gcpuseraccessbindings_createHandler(cfg),
	}
}
